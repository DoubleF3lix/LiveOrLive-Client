    ...
    return currentPlayer ? (
        <div className={`flex flex-col flex-grow border-solid border-${player.isSkipped ? "red-700" : "black"} border-2 rounded-lg p-3 m-3 lg:p-4 lg:m-4`}>
            ...
            <div className="flex flex-row mt-auto pt-2">
                {/* <button className="bg-gray-600 px-2 mx-0.5 text-white rounded h-8 flex-grow disabled:bg-opacity-50" onClick={shootPlayer} disabled={currentPlayer.username !== currentTurn}>
