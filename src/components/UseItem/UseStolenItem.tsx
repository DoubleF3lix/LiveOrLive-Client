...
export default function UseStolenItem({ selectedItemToSteal, playerUsernamesSelfFirst, playerUsernamesSelfLast, stolenItemTargetUsername, setStolenItemTargetUsername }: UseStolenItemArgs) {
    ...
    if (selectedItemToSteal === Item.ExtraLife) return <UseExtraLife usernames={playerUsernamesSelfFirst} targetUsername={stolenItemTargetUsername} setTargetUsername={setStolenItemTargetUsername} />;
    ...
    if (selectedItemToSteal === Item.Skip) return <UseSkip usernames={playerUsernamesSelfLast} targetUsername={stolenItemTargetUsername} setTargetUsername={setStolenItemTargetUsername} />;
    if (selectedItemToSteal === Item.Ricochet) return <UseRicochet usernames={playerUsernamesSelfFirst} targetUsername={stolenItemTargetUsername} setTargetUsername={setStolenItemTargetUsername} />;
    return null;
}